...
public class SignInAndSignOut extends JUnitStories {
 
	private Configuration configuration;
 
	public SignInAndSignOut() {
		super();
		...
		//configuration.useParanamer(new NUllPointer());
	...
	public InjectableStepsFactory stepsFactory() {
		return new InstanceStepsFactory(configuration(), new ViewHomePage());
	}
 
	@Override
	protected List<String> storyPaths() {
		return Arrays.asList("D:\\projects\\Demo\\src\\com\\test\\story\\SignInAndSignOut.story");
	}
}